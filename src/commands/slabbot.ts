...
export default class implements Command {
	...
	execute = async function (interaction: ChatInputCommandInteraction, client: Client) {
		...
		switch (subcommand) {
			case "about":
				return subcommandAbout(interaction, client);
			case "profile":
				return subcommandProfile(interaction);
			default:
				logger.error(`Unrecognized subcommand ${subcommand} in slabbot.`);
		}
	};
}

async function subcommandAbout(interaction: ChatInputCommandInteraction, client: Client) {
...
async function subcommandProfile(interaction: ChatInputCommandInteraction) {
